  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-background/80 dark:bg-background/80 border border-border",
        className,
      )}
    >
      {children}
